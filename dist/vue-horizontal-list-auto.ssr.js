...
var __vue_render__ = function __vue_render__() {
  ...
  }, [_vm.width.window > _vm._options.navigation.start ? _vm._ssrNode("<div class=\"vhl-navigation\" data-v-02b143fa>", "</div>", [_vm._hasPrev ? _vm._ssrNode("<div class=\"vhl-btn-left vhl-btn-left-custom\" data-v-02b143fa>", "</div>", [_vm._t("nav-prev", [_c('svg', {
    attrs: {
  ...
  })])])], 2) : _vm._e(), _vm._ssrNode(" "), _vm._hasNext ? _vm._ssrNode("<div class=\"vhl-btn-right vhl-btn-right-custom\" data-v-02b143fa>", "</div>", [_vm._t("nav-next", [_c('svg', {
    attrs: {
      "fill": _vm._options.navigation.color,
      "width": "32px",
      "height": "32px",
  ...
  })])])], 2) : _vm._e()], 2) : _vm._e(), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"vhl-container\"" + _vm._ssrStyle(null, _vm._style.container, null) + " data-v-02b143fa>", "</div>", [_vm._ssrNode("<div" + _vm._ssrClass("vhl-list", _vm._options.list.class) + _vm._ssrStyle(null, _vm._style.list, null) + " data-v-02b143fa>", "</div>", [_vm._l(_vm._items, function (item) {
    return _vm._ssrNode("<div" + _vm._ssrClass("vhl-item", _vm._options.item.class) + _vm._ssrStyle(null, _vm._style.item, null) + " data-v-02b143fa>", "</div>", [item.type === 'start' ? _vm._t("start") : item.type === 'end' ? _vm._t("end") : item.type === 'item' ? _vm._t("default", [_vm._v(_vm._s(item) + "\n        ")], {
      "item": item.item
    }) : _vm._e()], 2);
  }), _vm._ssrNode(" <div" + _vm._ssrStyle(null, _vm._style.tail, null) + " data-v-02b143fa></div>")], 2)])], 2);
};
...
var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
  if (!inject) return;
  inject("data-v-02b143fa_0", {
    source: ".vue-horizontal-list[data-v-02b143fa]{position:relative}.vhl-navigation[data-v-02b143fa]{display:flex;align-items:center;position:absolute;width:100%;height:100%}.vhl-btn-left[data-v-02b143fa],.vhl-btn-right[data-v-02b143fa]{width:48px;height:48px;display:flex;align-items:center;justify-content:center;border-radius:24px;background:#fff;box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);z-index:2}.vhl-btn-left[data-v-02b143fa]:hover,.vhl-btn-right[data-v-02b143fa]:hover{cursor:pointer}.vhl-btn-left[data-v-02b143fa]{margin-left:-24px;margin-right:auto}.vhl-btn-right[data-v-02b143fa]{margin-left:auto;margin-right:-24px}.vhl-container[data-v-02b143fa]{overflow-y:hidden;height:100%;margin-bottom:-24px}.vhl-list[data-v-02b143fa]{display:flex;padding-bottom:24px;margin-bottom:-24px;overflow-x:scroll;overflow-y:hidden;scroll-behavior:smooth;-webkit-overflow-scrolling:touch;scroll-snap-type:x mandatory}.vhl-item[data-v-02b143fa]{box-sizing:content-box}.vhl-list>*[data-v-02b143fa]{scroll-snap-align:start;flex-shrink:0}.vhl-item[data-v-02b143fa]{z-index:1}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_scope_id__ = "data-v-02b143fa";
/* module identifier */

var __vue_module_identifier__ = "data-v-02b143fa";
/* functional template */
...
var install = function install(Vue) {
  ...
  Vue.component('VueHorizontalListAuto', __vue_component__);
